...
async function getSongs(folder) {
    ...
    try {
        ...
        let response = await fetch(`https://github.com/Samad05imam/TOPSIFY_SPOTIFY_CLONE//tree/main${folder}/`);
        // let response = await fetch(`https://samad05imam.github.io/TOPSIFY_SPOTIFY_CLONE/${folder}/`);
...
const PlayMusic = (track, pause = false) => {
    ...
    currentSong.src = `https://github.com/Samad05imam/TOPSIFY_SPOTIFY_CLONE/tree/main/${currfolder}/${track}`;
    // currentSong.src = `https://samad05imam.github.io/TOPSIFY_SPOTIFY_CLONE/${currfolder}/${track}`;
